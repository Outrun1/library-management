<template>
  <div>
    <!-- 头部区域 -->
    <div style="height: 60px; line-height: 60px; background-color: #bb2323; margin-bottom: 2px; display: flex">
      <div style="width: 350px">
        <img src="@/assets/szu.png" alt="" style="width: 150px; position: relative; top: 10px; left: 20px">
