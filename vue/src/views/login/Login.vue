  ...
  <div style="height: 100vh; overflow: hidden; position: relative">
    <el-card class="cover" v-if="loginAdmin.id">
      ...
      <div style="width: 500px; height: 400px; background-color: white; border-radius: 10px;
        ...
        <div style="margin: 30px; text-align: center; font-size: 30px; font-weight: bold; color: #f33535">登 录</div>
        <el-form :model="admin" :rules="rules" ref="loginForm">
          ...
          <el-form-item>
            <el-button style="width: 100%; background-color: #f33535" size="medium" type="primary" @click="login">登录</el-button>
          </el-form-item>
        </el-form>
      </div>
  </div>
